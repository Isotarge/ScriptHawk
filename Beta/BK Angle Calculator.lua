...
-- Angle Calculation Code by The8bitbeast
...
local function set_point_1()
    forms.settext(p1xbox,Game.getXPosition())
    forms.settext(p1zbox,Game.getZPosition())
    forms.settext(anglebox,"")
end
    
local function set_point_2()
	forms.settext(p2xbox,Game.getXPosition())
    forms.settext(p2zbox,Game.getZPosition())
    forms.settext(anglebox,"")
end
...
local formhandle = forms.newform(390, 190, "Banjo Kazooie Angle Calculator");
...
-- Remainder of original script by Isotarge
