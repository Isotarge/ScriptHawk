...
// Fast File
// .org 0x807132BC
// ADDIU 		a0, r0, 0x50 // Set destination map after Nin/RW Logos to 0x50 (Main Menu)

// .org 0x807132CB
// ADDIU 		a2, r0, 0x5 // Set gamemode after Nin/RW Logos to 0x5 (Main Menu Mode)
...
VariableDisplay:
	...
	// 	LI 		a2, 0x3FC926E9 // Offset for "Real time" timing method. 2.0715 - 0.5
	// 	MTC1 	a2, f10
