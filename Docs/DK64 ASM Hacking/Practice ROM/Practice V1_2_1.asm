...
VariableDisplay:
	...
	VDispISG:
		...
		MTC1 	a2, f6 
		// LI 		a2, 0x41AAA62D // 21.3311405181884765625
		// LI 		a2, 0x41A7CE13 // 20.975621598551816
		LI 		a2, 0x41A93A20 // 21.153381052870058
		MTC1 	a2, f2
