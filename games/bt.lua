...
Game.OSD = {
	...
	{"DCW", Game.getDCWLocation, "mapData"},
	{"Separator"},
	{"X", nil, "position"},
	{"Y", nil, "position"},
	{"Z", nil, "position"},
	...
	{"Moving", Game.getMovingAngle, "angle"},
	{"Rot. Z", Game.getZRotation, "angle"},
	{"Separator"},
	{"Player", hexifyOSD(Game.getPlayerObject), "player"},
	{"Character", Game.getCharacterState, "character"},
	{"Movement", Game.getCurrentMovementStateOSD, "movement"},
	{"Animation", Game.getAnimationOSD, "animation"},
	{"Slope Timer", Game.getSlopeTimer, "floorProperties", Game.colorSlopeTimer},
	{"Grounded", Game.playerIsGrounded, "floorProperties"},
	{"Separator"},
	{"Camera", hexifyOSD(Game.getCameraObject), "camera"},
	{"Camera X", Game.getCameraXPosition, "camera"},
	{"Camera Y", Game.getCameraYPosition, "camera"},
	{"Camera Z", Game.getCameraZPosition, "camera"},
};
