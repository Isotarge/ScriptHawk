temporary_flags = {
	ntsc_u = {
		...
		{byte=0x5, bit=0, flagName="Fungi: BBlast GB Spawn Pending", type="Trigger", map=188},
		{byte=0x5, bit=1, flagName="Fungi: Apple Danger CS", type="Cutscene", map=48},
		...
		{byte=0x8, bit=2, flagName="Helm: Diddy Cage Barrel complete", type="Physical", map=17},
		{byte=0x8, bit=3, flagName="Helm: Tiny Mushroom Barrel complete", type="Physical", map=17},
		{byte=0x8, bit=4, flagName="Helm: Chunky Gun Barrel complete", type="Physical", map=17},
		{byte=0x8, bit=5, flagName="Helm: Lanky Gun Barrel complete", type="Physical", map=17},
		{byte=0x8, bit=6, flagName="Helm: DK Grate Punched", type="Physical", map=17},
		{byte=0x8, bit=7, flagName="Helm: Chunky Grate Punched", type="Physical", map=17},
		...
		{byte=0x9, bit=3, flagName="Helm: DK Room Shut Down", type="Physical", map=17},
		{byte=0x9, bit=4, flagName="Helm: Chunky Room Shut Down", type="Physical", map=17},
		{byte=0x9, bit=5, flagName="Helm: Tiny Room Shut Down", type="Physical", map=17},
		{byte=0x9, bit=6, flagName="Helm: Lanky Room Shut Down", type="Physical", map=17},
		{byte=0x9, bit=7, flagName="Helm: Diddy Room Shut Down", type="Physical", map=17},
		...
		{byte=0xB, bit=3, flagName="K. Rool: Cranky CS", type="Cutscene", map=215},
		...
		{byte=0xC, bit=3, flagName="Factory: Arcade in Story Mode", type="Minigame", map=26},
		{byte=0xC, bit=4, flagName="Global: Training Barrel Spawn Pending", type="Trigger", map=5},
