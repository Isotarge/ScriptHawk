...
-- Game Progress
	...
	{name="Termite Tokens Paid",			index=0x90,	type="Prog",	level=1},
	{name="Pumpkin Tokens Paid",			index=0x91,	type="Prog",	level=10},
	{name="Walrus Tokens Paid",				index=0x92,	type="Prog",	level=5},
	{name="Croc Tokens Paid",				index=0x93,	type="Prog",	level=4},
	{name="Bee Tokens Paid",				index=0x94,	type="Prog",	level=8},
