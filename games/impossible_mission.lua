...
Game.standardOSD = {
	{"Map", hexifyOSD(Game.getCurrentMap), "mapData"},
	{"IGT", Game.getIGT, "igt"},
	{"Snooze Timer", Game.getSnoozeTimer, "snoozeTimer"},
	{"Separator"},
	{"X", nil, "position"},
	{"Y", nil, "position"},
	{"Separator"},
	...
	{"Separator"},
	{"Piece Dist", Game.getPieceDistributionOSD, "distribution"},
	{"Best Dist", Game.getBestPieceDistribution, "distribution"},
	{"Separator"},
	{"Flips Requried", Game.getPuzzleFlipsRequired, "flips"},
	{"Best Flips Req", Game.getBestPuzzleFlipsRequired, "flips"},
	{"Separator"},
	{"Color Required", Game.getPuzzleColorChangesRequired, "color"},
	{"Best Color Req", Game.getBestPuzzleColorChangesRequired, "color"},
	{"Separator"},
	{"Total Search Length", Game.getTotalSearchBarLength, "search"},
	{"Best Search Length", Game.getBestSearchLength, "search"},
};
