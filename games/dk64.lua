...
Game.standardOSD = {
	...
	{"Level", Game.getLevelIndexOSD, "mapData"},
	{"Cutscene", Game.getCutsceneOSD, "cutsceneData"},
	{"Exit", Game.getExitOSD, "mapData"},
	{"Player", hexifyOSD(Game.getPlayerObject), "player"},
	{"Separator"},
	{"Mode", Game.getCurrentMode, "gamemode"},
	{"File", Game.getFileOSD, "fileView"},
	{"Flags", getFlagStatsOSD, "flags"},
	{"Separator"},
	{"X", nil, "position"},
	{"Y", nil, "position"},
	{"Z", nil, "position"},
	{"Separator"},
	{"Floor", Game.getFloor, "position"},
	{"Separator"},
	{"Lag Factor", Game.getLagFactor, "lag"},
	{"dY", nil, "positionStats"},
	{"dXZ", nil, "positionStats"},
	{"Velocity", Game.getVelocity, "speed"},
	--{"Accel", Game.getAcceleration, "speed"}, -- TODO: Game.getAcceleration
	{"Y Velocity", Game.getYVelocity, "speed"},
	{"Y Accel", Game.getYAcceleration, "speed"},
	{"Separator"},
	...
	{"Facing", Game.getYRotation, "angle", true, Game.colorYRotation},
	--{"Moving", Game.getMovingRotation, "angle"}, -- TODO: Game.getMovingRotation
	{"Rot. Z", Game.getZRotation, "angle"},
	{"Movement", Game.getMovementState, "movement"},
	{"Animation", Game.getAnimation, "animation"},
	{"Camera", Game.getCameraState, "camera"},
	{"Noclip", Game.getNoclipByte, "noclip", true, Game.colorNoclipByte},
	{"Separator"},
	{"Anim Timer 1", Game.getAnimationTimer1, "animation"},
	{"Anim Timer 2", Game.getAnimationTimer2, "animation"},
	{"Anim Timer 3", Game.getAnimationTimer3, "animation"},
	{"Anim Timer 4", Game.getAnimationTimer4, "animation"},
	{"Separator"},
	{"Bone Array 1", function() return Game.getBoneArray1PrettyPrint(Game.getPlayerObject()) end, "bonearray"},
	{"Stored X1", function() return Game.getStoredX1(Game.getPlayerObject()) end, "bonearray"},
	{"Stored Y1", function() return Game.getStoredY1(Game.getPlayerObject()) end, "bonearray"},
	{"Stored Z1", function() return Game.getStoredZ1(Game.getPlayerObject()) end, "bonearray"},
	{"Separator"},
	{"Bone Array 2", function() return Game.getBoneArray2PrettyPrint(Game.getPlayerObject()) end, "bonearray"},
	{"Stored X2", function() return Game.getStoredX2(Game.getPlayerObject()) end, "bonearray"},
	{"Stored Y2", function() return Game.getStoredY2(Game.getPlayerObject()) end, "bonearray"},
	{"Stored Z2", function() return Game.getStoredZ2(Game.getPlayerObject()) end, "bonearray"},
	{"Separator"},
	{"Free", Game.getFreeMemory, "memory"},
	{"Used", Game.getUsedMemory, "memory"},
	{"Total", Game.getTotalMemory, "memory"},
};
...
Game.mapDebugOSD = {
	...
	{"Movement", Game.getMovementState, "movement"},
	{"Separator"},
	{"Map Block", hexifyOSD(Game.getMapBlock, 6, ""), "mapData"},
	{"Map Verts Start", hexifyOSD(Game.getMapVerts, 6, ""), "mapData"},
	{"Map Verts End", hexifyOSD(Game.getMapVertsEnd, 6, ""), "mapData"},
	{"Map DL Start", hexifyOSD(Game.getMapDLStart, 6, ""), "mapData"},
	{"Chunk Array", hexifyOSD(Game.getChunkArray, 6, ""), "mapData"},
};
