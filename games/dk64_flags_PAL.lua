local flag_array = {
	{["byte"] = 0x0, ["bit"] = 6, ["name"] = "Kong Unlocked: Diddy"},
	{["byte"] = 0x8, ["bit"] = 2, ["name"] = "Kong Unlocked: Tiny"},
	{["byte"] = 0x8, ["bit"] = 6, ["name"] = "Kong Unlocked: Lanky"},
	{["byte"] = 0xE, ["bit"] = 5, ["name"] = "Kong Unlocked: Chunky"},
