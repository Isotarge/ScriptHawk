...
Game.OSD = {
	...
	{"IGT", Game.getIGT, "igt"},
	{"Separator"},
	{"Level Y", Game.getLevelY, "mapData"},
	{"Scrolling", Game.isLevelScrolling, "mapData"},
	{"Separator"},
	{"X", nil, "position"},
	{"Y", nil, "position"},
	...
	{"Separator"},
	{"Egg X", Game.getEggXPosition, "egg"},
	{"Egg Y", Game.getEggYPosition, "egg"},
	{"Egg X Velocity", Game.getEggXVelocity, "egg"},
	{"Egg Y Velocity", Game.getEggYVelocity, "egg"},
};
