...
Game.OSD = {
	...
	{"Separator"},
	{"Y Velocity", Game.getYVelocity, "speed", Game.colorYVelocity},
	...
	{"Separator"},
	{"Movement", Game.getCurrentMovementState, "movement", Game.colorCurrentMovementState},
	{"Slope Timer", Game.getSlopeTimer, "floorProperties", Game.colorSlopeTimer},
	{"Grounded", Game.isGrounded, "floorProperties"},
	{"Wall Collisions", Game.getWallCollisions, "wallProperties"},
	{"Separator"},
	{"Facing", Game.getFacingAngle, "angle"},
	{"Moving", Game.getYRotation, "angle"},
	{"Moving Angle", nil, "angle"},
	{"Rot. X", Game.getXRotation, "angle"},
	{"Rot. Z", Game.getZRotation, "angle"},
	{"Separator"},
	{"FF Answer", getCorrectFFAnswer, "ffunAnswer"},
	{"FF Pattern", Game.getFFPattern, "ffunPattern"},
	{"Separator"},
	{"Jiggy Grabbed", Game.getJiggyGrabbedPointer, "objectDespawn"},
	{"Index Grabbed", Game.getJiggyGrabbedIndex, "objectDespawn"},
};
