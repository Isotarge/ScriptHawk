...
Game.OSD = {
	...
	{"dX"},
	{"dY"},
	{"D. Health", function() return mainmemory.readbyte(0x1240); end},
	{"D. Health", function() return mainmemory.readbyte(0x1241); end},
	{"D. Health", function() return mainmemory.readbyte(0x138D); end},
};
