...
Game.OSD = {
	...
	{"Separator"},
	{"Spin Timer", Game.getSpinTimer, "carProperties", Game.colorSpinTimer},
	{"Boost", Game.getBoost, "carProperties"},
	{"Velocity", Game.getVelocity, "speed"},
	{"Acceleration", Game.getAcceleration, "speed"},
	{"Y Velocity", Game.getYVelocity, "speed"},
	{"Lateral Velocity", Game.getLateralVelocity, "speed"},
	{"Lateral Acceleration", Game.getLateralAcceleration, "speedMore"},
	{"Throttle", Game.getThrottle, "carProperties"},
	{"Separator"},
	...
	--{"Moving", Game.getMovingRotation, "movingAngle"},
	{"Rot. Z", Game.getZRotation, "angle"},
	{"Separator"},
	{"Game Settings", hexifyOSD(Game.getGameSettings), "settings"},
	{"Player", hexifyOSD(Game.getPlayerObject), "player"},
	{"Checkpoint", Game.getCheckpointOSD, "mapData"},
	{"Wheel Ground (F)", Game.getFrontWheelGroundOSD, "carProperties"},
	{"Wheel Ground (B)", Game.getBackWheelGroundOSD, "carProperties"},
};
