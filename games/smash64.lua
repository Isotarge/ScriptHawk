...
local boomerangOSD = {
	[1] = {
		...
		{"Boomerang X", Game.getBoomerangX, category = "position"},
		{"Boomerang Y", Game.getBoomerangY, category = "position"},
		{"Separator"},
	},
	[2] = {
		{"Boomerang", function() return Game.getBoomerangOSD(2) end, category = "boomerang"},
		{"Boomerang X", function() return Game.getBoomerangX(2) end, category = "position"},
		{"Boomerang Y", function() return Game.getBoomerangY(2) end, category = "position"},
		{"Separator"},
	},
	[3] = {
		{"Boomerang", function() return Game.getBoomerangOSD(3) end, category = "boomerang"},
		{"Boomerang X", function() return Game.getBoomerangX(3) end, category = "position"},
		{"Boomerang Y", function() return Game.getBoomerangY(3) end, category = "position"},
		{"Separator"},
	},
	[4] = {
		{"Boomerang", function() return Game.getBoomerangOSD(4) end, category = "boomerang"},
		{"Boomerang X", function() return Game.getBoomerangX(4) end, category = "position"},
		{"Boomerang Y", function() return Game.getBoomerangY(4) end, category = "position"},
		{"Separator"},
	},
};
